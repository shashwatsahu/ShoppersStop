...
public class NearbyShopActivity extends AppCompatActivity implements GeoQueryEventListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.example.hp.shoppersstop.R.layout.activity_nearby_shop);

        mToolbar = findViewById(com.example.hp.shoppersstop.R.id.toolbar2);
        mListOfShops = findViewById(com.example.hp.shoppersstop.R.id.list_of_shops);
        mShimmerFrameLayout = findViewById(com.example.hp.shoppersstop.R.id.shimmerViewContainer);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(com.example.hp.shoppersstop.R.menu.menu,menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        {
            case com.example.hp.shoppersstop.R.id.search_option: //start search activity
                        break;
            case com.example.hp.shoppersstop.R.id.map_view_option : //start map activity
